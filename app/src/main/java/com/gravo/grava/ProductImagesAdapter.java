...
public class ProductImagesAdapter extends RecyclerView.Adapter<ProductImagesAdapter.SliderViewHolder> {
    ...
    public SliderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Layout file ka naam check karein: item_product_image_slider
        View view = LayoutInflater.from(context).inflate(R.layout.item_product_image_slider, parent, false);
